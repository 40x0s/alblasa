...
|---|---|---|
| `CrackGuide.md` | **المقدِّم فقط** | دليل الكسر خطوة بخطوة (35–40 دق) + تجهيزات مسبقة + استكشاف أخطاء |
| `Workshop_Slides.md` | المقدِّم | محتوى 20 سلايد (عنوان + نقاط + ملاحظة مقدِّم لكل سلايد) |
| `LabSheet.md` | الطلاب | ورقة عمل قابلة للتعبئة: حقول + أسئلة تأملية + قائمة تسليم |
| `README_Workshop.md` | الجميع | نظرة عامة: بيانات الدخول، الأدوات، الخطوات المختصرة |
| `Tools_Links.txt` | الجميع | روابط تحميل الأدوات (dnSpy · Procmon · x32dbg · Python) |

> ملاحظة: حزمة `Workshop_Delivery\` (عبر Workshop_Pack.bat) **لا تتضمن**
> CrackGuide.md ولا السلايدات — فهما يحتويان كل الأجوبة، ويُسلَّمان للمقدِّم فقط.
